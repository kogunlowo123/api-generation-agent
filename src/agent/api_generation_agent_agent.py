"""API Generation Agent - Main Agent Implementation."""
...
class ApiGenerationAgentAgent:
    ...
    def __init__(self):
        ...
        self.openapi_codegen_enabled = True
        self.graphql_codegen_enabled = True
        self.sdk_generation_enabled = True
        self.validation_middleware_enabled = True
        self.rate_limiting_enabled = True
        self._tool_dispatch = {
            "generate_rest_api": self.tools.generate_rest_api,
            "generate_graphql_api": self.tools.generate_graphql_api,
            "generate_client_sdk": self.tools.generate_client_sdk,
            "generate_api_tests": self.tools.generate_api_tests,
            "validate_api_spec": self.tools.validate_api_spec,
            "generate_api_gateway_config": self.tools.generate_api_gateway_config,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['openapi_codegen', 'graphql_codegen', 'sdk_generation', 'validation_middleware', 'rate_limiting'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            "generate_rest_api": ['generate', 'rest', 'api'],
            "generate_graphql_api": ['generate', 'graphql', 'api'],
            "generate_client_sdk": ['generate', 'client', 'sdk'],
            "generate_api_tests": ['generate', 'api', 'tests'],
            "validate_api_spec": ['validate', 'api', 'spec'],
            "generate_api_gateway_config": ['generate', 'api', 'gateway', 'config'],
        }
